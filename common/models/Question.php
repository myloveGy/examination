...
class Question extends TimeModel
{
    ...
    public function rules()
    {
        return [
            ...
            [['question_title', 'question_content', 'question_img', 'answer_id'], 'string'],
            [['answer_type', 'status', 'created_at', 'updated_at', 'subject_id', 'chapter_id', 'special_id', 'error_number', 'do_number'], 'integer'],
        ];
    }
