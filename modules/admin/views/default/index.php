            ...
            <ul class="nav ace-nav">
                ...
                <li class="light-blue">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <img class="nav-user-photo" src="<?=$this->params['user']->face ? $this->params['user']->face : '/resource/avatars/avatar.jpg'?>" alt="Jason's Photo" />
...
<div class="main-container main-container-fixed" id="main-container">
    ...
    <div class="main-content">
        ...
        <div class="page-content" id="page-content">
            <iframe class="active iframe" name="iframe-index" id="iframe-index" width="100%" height="100%" src="<?=Url::toRoute(['default/system'])?>" frameborder="0"></iframe>
        </div>
    </div>
</div>
<!-- 公共的JS文件 -->
